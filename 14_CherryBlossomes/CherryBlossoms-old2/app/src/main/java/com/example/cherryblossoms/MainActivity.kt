...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val onItemSelected: (Cherry) -> Unit = {
            Toast.makeText(this, "${it.name} がタップされました",
                Toast.LENGTH_SHORT).show()
            val url = "https://www.google.com/maps/@${it.longitude},${it
                .latitude},16z"
        ...
        setContent {
            CherryBlossomsTheme {
                ...
                Surface(
                    ...
                    //Greeting("Android")
                    CherryList(list = list, onSelected = onItemSelected)
                }
            }
        }
    }
...
// 参考:https://www.baeldung.com/kotlin/fuel
...
class DataViewModel() : ViewModel() {
    ...
    fun query() {
        ...
        val httpAsync = "https://ja.wikipedia.org/w/api.php?" +
                ...
                "list=search&" +
                "formatversion=2&" +
                "srsearch=%E6%A1%9C%E3%81%AE%E5%90%8D%E6%89%80&" +
                "srlimit=100"
                    .httpGet()
                    .responseString { request, response, result ->
                        when (result) {
                            ...
                            is Result.Success -> {
                                ...
                                val result = Json.decodeFromString<ApiResult>(data)
